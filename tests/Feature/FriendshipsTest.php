...
class FriendshipsTest extends TestCase
{
    ...
    /** @test */
    function unauthenticated_users_cannot_see_a_user_list()
    {
    ...
    function authenticated_users_can_friend_a_user ()
    {
        ...
        $this->assertCount(1, $sender->getAllFriendships());
        $this->assertCount(1, $recipient->getAllFriendships());
    }
    ...
    function authenticated_users_can_unfriend_a_user ()
    {
        ...
        $this->post('/unfriend/' . $recipient->username);
