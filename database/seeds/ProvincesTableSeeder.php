...
class ProvincesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('provinces')->insert(array(
            ...
            array('id' => '17', 'country_code' => 'US', 'province_code' => 'AS', 'province_name_en' => 'American Samoa', 'type' => 'T', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')),
            ...
            array('id' => '25', 'country_code' => 'US', 'province_code' => 'FM', 'province_name_en' => 'Federated States of Micronesia', 'type' => 'AS', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')),
            ...
            array('id' => '27', 'country_code' => 'US', 'province_code' => 'GU', 'province_name_en' => 'Guam', 'type' => 'T', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')),
            ...
            array('id' => '39', 'country_code' => 'US', 'province_code' => 'MH', 'province_name_en' => 'Marshall Islands', 'type' => 'T', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')),
            ...
            array('id' => '43', 'country_code' => 'US', 'province_code' => 'MP', 'province_name_en' => 'Northern Mariana Islands', 'type' => 'CW', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')),
            ...
            array('id' => '58', 'country_code' => 'US', 'province_code' => 'PR', 'province_name_en' => 'Puerto Rico', 'type' => 'CW', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')),
            array('id' => '59', 'country_code' => 'US', 'province_code' => 'PW', 'province_name_en' => 'Palau', 'type' => 'AS', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')),
            ...
            array('id' => '67', 'country_code' => 'US', 'province_code' => 'VI', 'province_name_en' => 'Virgin Islands', 'type' => 'T', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')),
