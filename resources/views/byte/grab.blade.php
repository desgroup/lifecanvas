        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    <div class="panel-heading"><h3 class="panel-title">Grab this Byte</h3></div>
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="/bytes" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="asset_id" id="asset_id" value="{{ $byte->asset_id }}">
                            <input type="hidden" name="lat" id="lat" value="{{ $byte->lat }}">
                            <input type="hidden" name="lng" id="lng" value="{{ $byte->lng }}">
                            <input type="hidden" name="parent_byte_id" id="parent_byte_id" value="{{ $byte->parent_byte_id ?? $byte->id }}">
                            <script>
                            ...
                            <div class='row form-group'>
                                <div class="col-md-12">
                                <button type="submit" class="btn btn-raised btn-primary">Grab this Byte</button>
