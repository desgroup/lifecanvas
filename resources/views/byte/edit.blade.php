                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="/bytes/{{ $byte->id }}" enctype="multipart/form-data">
                            ...
                            <div class="row form-group">
                                <div class="col-md-4">
                                    {{ old('place_id') ?? $byte->place_id ?? NULL }}
                                ...
                                <div class="col-md-4">
                                    {{ old('timezone_id') ?? $byte->timezone_id ??  NULL }}
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="checkbox" name="use_image_time" id="use_image_time" {{ old('use_image_time') == "on" ? "checked" : ""}}>
                                </div>
                            </div>
                            <div class='form-group'>
                                <button type="submit" class="btn btn-primary mr-1">Update Byte</button>
